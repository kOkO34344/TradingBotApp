...
status: "Live — integrated, backtested at daily AND hourly cadence, no measurable edge found either way"
...
| Backtested (walk-forward, IC + portfolio sim) — daily | ✅ Done 2026-07-23 — **no measurable edge found** (IC 0.036, 50% hit rate) |
| IC-screened at hourly cadence | ✅ Done 2026-07-24 — **also no edge** (IC -0.081, 46.4% hit rate) |
| Selectable in `autotrade_runner.py` (unattended hourly toggle) | ✅ Built 2026-07-24 — opt-in, OFF by default, deliberate experiment despite no edge |
